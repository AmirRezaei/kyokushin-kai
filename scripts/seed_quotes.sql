...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('i9j0k1l2', '{"id":"i9j0k1l2","author":"Bruce Lee","tags":["Martial Arts","Adaptability","Philosophy"],"date":"1970-10-01","text":"Be like water making its way through cracks. Do not be assertive, but adjust to the object, and you shall find a way around or through it.","meaning":"Encourages flexibility and adaptability, principles applicable to Karate and other martial arts.","history":"Although primarily known for Jeet Kune Do, Bruce Lee''s philosophies influence various martial arts disciplines.","reference":"Source: ''Tao of Jeet Kune Do''","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Bruce Lee', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('y5z6a7b8', '{"id":"y5z6a7b8","author":"Chojun Miyagi","tags":["Karate","Technique","Mastery"],"date":"1933-04-10","text":"Technique is nothing without the heart behind it.","meaning":"Underlines the necessity of passion and emotional commitment in mastering Karate techniques.","history":"Chojun Miyagi founded Goju-Ryu Karate, focusing on both hard and soft techniques.","reference":"Source: Goju-Ryu Karate teachings","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Chojun Miyagi', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('c9d0e1f2', '{"id":"c9d0e1f2","author":"Kenwa Mabuni","tags":["Karate","Tradition","Discipline"],"date":"1955-09-30","text":"In Karate, the one who perseveres is the true winner.","meaning":"Emphasizes perseverance as the key to success in Karate practice and life.","history":"Kenwa Mabuni was a prominent Karate master who blended Shorin and Goju styles to create Shito-Ryu.","reference":"Source: Shito-Ryu Karate manuals","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Kenwa Mabuni', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('w9x0y1z2', '{"id":"w9x0y1z2","author":"Tsutomu Ohshima","tags":["Karate","Education","Leadership"],"date":"1990-11-05","text":"A true Karateka leads by example, inspiring others through their dedication and integrity.","meaning":"Stresses the role of leadership and personal example in the Karate community.","history":"Tsutomu Ohshima founded Wadō-ryū Karate and has been a prominent figure in Karate education.","reference":"Source: Wadō-ryū Karate publications","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Tsutomu Ohshima', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('a3b4c5d6', '{"id":"a3b4c5d6","author":"Gogen Yamaguchi","tags":["Karate","Mindset","Perseverance"],"date":"1968-07-19","text":"The mind is the strongest weapon in Karate. Train it well.","meaning":"Underscores the significance of mental strength and perseverance in Karate training.","history":"Gogen Yamaguchi, also known as Yamaguchi Gogen, was a master of Goju-Ryu Karate and a renowned teacher.","reference":"Source: Goju-Ryu Karate teachings","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Gogen Yamaguchi', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('e7f8g9h0', '{"id":"e7f8g9h0","author":"Shigeru Egami","tags":["Karate","Spirit","Determination"],"date":"1985-03-30","text":"With unwavering determination, no obstacle in Karate is insurmountable.","meaning":"Encourages a determined spirit to overcome challenges in Karate practice.","history":"Shigeru Egami is recognized for his dedication to Karate and his influence on modern Karate training.","reference":"Source: Karate dojo interviews","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Shigeru Egami', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('m5n6o7p8', '{"id":"m5n6o7p8","author":"Seikichi Toguchi","tags":["Karate","Balance","Harmony"],"date":"2000-06-25","text":"True balance in Karate comes from harmonizing body, mind, and spirit.","meaning":"Emphasizes the holistic approach to achieving balance through Karate practice.","history":"Seikichi Toguchi is known for his teachings on the harmonious aspects of Karate.","reference":"Source: Karate harmony seminars","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Seikichi Toguchi', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('u3v4w5x6', '{"id":"u3v4w5x6","author":"Katsuhiko Shinzato","tags":["Karate","Focus","Persistence"],"date":"2020-02-14","text":"Focus your energy, persist through challenges, and Karate will reveal its true essence.","meaning":"Encourages focused effort and persistence to understand the deeper aspects of Karate.","history":"Katsuhiko Shinzato is a respected Karate instructor known for his emphasis on mental focus.","reference":"Source: Karate training workshops","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Katsuhiko Shinzato', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('y7z8a9b0', '{"id":"y7z8a9b0","author":"Tadashi Nakamura","tags":["Karate","Respect","Humility"],"date":"2023-08-08","text":"Respect your opponent, humble yourself in victory, and learn from every encounter.","meaning":"Promotes respect, humility, and continuous learning through Karate practice.","history":"Tadashi Nakamura is a senior Karate master renowned for his teachings on respect and humility.","reference":"Source: Nakamura Karate Academy publications","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Tadashi Nakamura', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('f1u2n3a4', '{"id":"f1u2n3a4","author":"Gichin Funakoshi","tags":["Karate","Courtesy","Respect"],"date":"1943-09-15","text":"Karate begins and ends with courtesy.","meaning":"Emphasizes the importance of respect and polite behavior as foundational elements of Karate practice.","history":"Gichin Funakoshi believed that true Karate goes beyond physical techniques to encompass moral and ethical behavior.","reference":"Source: ''Karate-Do: My Way of Life''","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Gichin Funakoshi', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('f1u2n3a4', '{"id":"f1u2n3a4","author":"Gichin Funakoshi","tags":["Karate","Courage","Perseverance"],"date":"1956-07-01","text":"Courage is not the absence of fear, but the triumph over it.","meaning":"Highlights that true courage involves facing and overcoming one''s fears through Karate practice.","history":"Funakoshi emphasized that overcoming fear is essential for personal growth and mastery in Karate.","reference":"Source: ''Karate-Do: My Way of Life''","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Gichin Funakoshi', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('f3u4n5a6', '{"id":"f3u4n5a6","author":"Gichin Funakoshi","tags":["Karate","Focus","Concentration"],"date":"1956-07-01","text":"Focus your mind, and your Karate will follow.","meaning":"Highlights the importance of mental concentration in executing Karate techniques effectively.","history":"Funakoshi emphasized that mental clarity and focus are as crucial as physical training.","reference":"Source: ''Karate-Do: My Way of Life''","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Gichin Funakoshi', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('f7u8n9a0', '{"id":"f7u8n9a0","author":"Gichin Funakoshi","tags":["Karate","Respect","Courtesy"],"date":"1956-07-01","text":"Courtesy is the soul of Karate.","meaning":"Underscores that respectful behavior is integral to the practice and spirit of Karate.","history":"Funakoshi believed that maintaining courtesy fosters a positive and disciplined training environment.","reference":"Source: ''Karate-Do: My Way of Life''","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Gichin Funakoshi', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
...
INSERT INTO quotes (id, data_json, author, status, created_at, updated_at, version)
VALUES ('f4u5n6a7', '{"id":"f4u5n6a7","author":"Gichin Funakoshi","tags":["Karate","Courtesy","Respect"],"date":"1956-07-01","text":"Karate begins and ends with courtesy.","meaning":"Emphasizes that polite behavior and respect are fundamental to the practice and spirit of Karate.","history":"Funakoshi believed that manners and respect are essential traits that Karate cultivates in its practitioners.","reference":"Source: ''Karate-Do: My Way of Life''","status":"published","createdAt":"2026-01-05T22:28:42.350Z","updatedAt":"2026-01-05T22:28:42.350Z"}', 'Gichin Funakoshi', 'published', '2026-01-05T22:28:42.350Z', '2026-01-05T22:28:42.350Z', 1)
ON CONFLICT(id) DO UPDATE SET
  data_json = excluded.data_json,
  author = excluded.author,
  status = excluded.status,
