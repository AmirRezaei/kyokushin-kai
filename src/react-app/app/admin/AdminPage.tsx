...
const AdminPage: React.FC = () => {
   ...
   }, [filteredGrades, gradeSortDirection, gradeSortKey]);
   ...
   const orderedKatas = useMemo(() => {
      ...
      return [...filteredKatas].sort((a, b) => {
         ...
         switch (kataSortKey) {
            ...
            case 'rank': {
               const rankA =
                  Number.isFinite(a.rank) && a.rank > 0
                     ? a.rank
                     : deriveGradeRank(a.kind as GradeKind, a.number);
               const rankB =
                  Number.isFinite(b.rank) && b.rank > 0
                     ? b.rank
                     : deriveGradeRank(b.kind as GradeKind, b.number);
               result = rankA - rankB;
               break;
            }
            case 'status':
   ...
   const handleSaveTechnique = async () => {
      ...
      try {
         ...
         const rankValue =
            Number.isFinite(formState.rank) && formState.rank > 0
               ? formState.rank
               : gradeRank;
         const payload = {
            kind: formState.kind,
   ...
   const handleEditGrade = (grade: AdminGrade) => {
      ...
      setGradeFormState({
         ...
         rank: Number.isFinite(grade.rank)
            ? grade.rank
            : deriveGradeRank(grade.kind as GradeKind, grade.number),
   ...
   const handleSaveKata = async () => {
      if (!token) return;
      const hasName = Boolean(kataFormState.nameRomaji || kataFormState.nameEn || kataFormState.nameSv);
      if (!hasName) {
      ...
      try {
         ...
         const res = await fetch(
            kataEditingId ? `/api/v1/katas/${kataEditingId}` : '/api/v1/katas',
            {
               ...
               >
                  ...
                  <TableContainer sx={{maxHeight: 520}}>
                     <Table size="small" stickyHeader>
                        <TableHead>
                           <TableRow>
                              <TableCell sortDirection={techniqueSortKey === 'name' ? techniqueSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={techniqueSortKey === 'kind' ? techniqueSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={techniqueSortKey === 'rank' ? techniqueSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={techniqueSortKey === 'status' ? techniqueSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={techniqueSortKey === 'grade' ? techniqueSortDirection : false}>
                                 <TableSortLabel
                              ...
                              if (editingId === technique.id) {
                                 return (
                                    ...
                                    >
                                       ...
                                       <TableCell sx={{verticalAlign: 'top'}}>
                                          <FormControl size="small" fullWidth>
                                             <InputLabel id="technique-status-label">
                                                Status
                                             </InputLabel>
                                             <Select
                                                labelId="technique-status-label"
               ...
               >
                  ...
                  <TableContainer sx={{maxHeight: 520}}>
                     <Table size="small" stickyHeader sx={{minWidth: 980}}>
                        <TableHead>
                           <TableRow>
                              <TableCell sortDirection={gradeSortKey === 'name' ? gradeSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={gradeSortKey === 'kind' ? gradeSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={gradeSortKey === 'rank' ? gradeSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={gradeSortKey === 'beltColor' ? gradeSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={gradeSortKey === 'sortOrder' ? gradeSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={gradeSortKey === 'status' ? gradeSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={gradeSortKey === 'techniques' ? gradeSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={gradeSortKey === 'katas' ? gradeSortDirection : false}>
                                 <TableSortLabel
                                       ...
                                       >
                                          {sortedTechniques.map((technique) => (
                                             <MenuItem key={technique.id} value={technique.id}>
                                                ...
                                                />
                                                <ListItemText
                                                   primary={technique.name.romaji || technique.name.en || technique.id}
                                                />
                                             </MenuItem>
                                          ))}
                                       </Select>
                                       ...
                                       >
                                          {sortedKatas.map((kata) => (
                                             <MenuItem key={kata.id} value={kata.id}>
                                                ...
                                                <ListItemText primary={kata.name.romaji || kata.name.en || kata.id} />
                                             </MenuItem>
                                          ))}
                                       </Select>
                                    </FormControl>
                              ...
                              const secondaryName =
                                 grade.name.romaji && grade.name.en
                                    ? primaryName === grade.name.romaji
                                       ...
                                       : grade.name.romaji
                                    : grade.id;
                              const rankValue = Number.isFinite(grade.rank)
                                 ? grade.rank
                                 : deriveGradeRank(grade.kind as GradeKind, grade.number);
                              ...
                              if (gradeEditingId === grade.id) {
                                 return (
                                    ...
                                    >
                                       ...
                                       <TableCell sx={{verticalAlign: 'top'}}>
                                          <FormControl size="small" fullWidth>
                                             <InputLabel id="grade-techniques-label-edit">
                                                Techniques
                                             </InputLabel>
                                             <Select
                                             ...
                                             >
                                                {sortedTechniques.map((technique) => (
                                                   <MenuItem key={technique.id} value={technique.id}>
                                                      <Checkbox
                                                         checked={gradeFormState.techniqueIds.includes(
                                                            technique.id,
                                                         )}
                                                      />
                                                      <ListItemText
                     ...
                     <Table size="small" stickyHeader>
                        <TableHead>
                           <TableRow>
                              ...
                              <TableCell sortDirection={kataSortKey === 'status' ? kataSortDirection : false}>
                                 <TableSortLabel
                              ...
                              <TableCell sortDirection={kataSortKey === 'grade' ? kataSortDirection : false}>
                                 <TableSortLabel
                              ...
                              if (kataEditingId === kata.id) {
                                 return (
                                    ...
                                    >
                                       ...
                                       <TableCell sx={{verticalAlign: 'top'}}>
                                          <FormControl size="small" fullWidth>
                                             <InputLabel id="kata-status-label-edit">
                                                Status
                                             </InputLabel>
                                             <Select
                              ...
                              return (
                                 <TableRow key={kata.id} hover>
                                    ...
                                    <TableCell>
                                       <Chip
                                          label={
                                             gradeNameById.get(kataGradeMap.get(kata.id) || '') ||
                                             'Unassigned'
                                          }
                                          size="small"
                                          variant="outlined"
