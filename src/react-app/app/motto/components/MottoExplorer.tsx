...
export const MottoExplorer: React.FC<MottoExplorerProps> = ({ motto, index, onBack }) => {
  ...
  useEffect(() => {
    ...
    const fetchAnalysis = async () => {
      setLoading(true);
      try {
        const result = analyzeMotto[motto.shortTitle];
                    ...
                    <Box sx={{ position: 'relative', zIndex: 1, mb: 6 }}>
                      <Box
                        sx={{
                          ...
                          boxShadow:
                            breathPhase === 'inhale'
                              ? `0 0 50px ${theme.palette.primary.main}80`
                              : 'none',
                        }}
                      >
                        <Typography
                      ...
                      <Box display="flex" alignItems="center" mb={3}>
                        ...
                        >
                          {(() => {
                            ...
                            return (
                              <Icon sx={{ fontSize: 24, color: theme.palette.primary.main }} />
                            );
                          })()}
                        </Box>
