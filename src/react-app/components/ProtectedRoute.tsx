...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ children }) => {
  ...
  React.useEffect(() => {
    if (isLoading || isAuthenticated || hasLoggedRef.current) {
      return;
    }
      ...
      <Container maxWidth="sm">
        ...
        >
          ...
          >
            ...
            >
              This page requires you to be logged in. Please sign in with your Google account to
              access your personalized training data and settings.
            </Typography>
