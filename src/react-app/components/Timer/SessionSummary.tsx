// HEADER-START
// * Project: Kyokushin
// * Path: src/components/Timer/SessionSummary.tsx
...
export const SessionSummary: React.FC<SessionSummaryProps> = ({intervals}) => {
   ...
   return (
      <Card>
         <CardContent>
            ...
            <Typography>Total Rounds: {totalRounds}</Typography>
            <Typography>Total Time: {totalTime}s</Typography>
         </CardContent>
      </Card>
   );
};
