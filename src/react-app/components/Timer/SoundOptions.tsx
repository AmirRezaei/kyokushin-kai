// HEADER-START
// * Project: Kyokushin
// * Path: src/components/Timer/SoundOptions.tsx
...
// ./src/components/Timer/SoundOptions.tsx
...
export const SoundOptions: React.FC<SoundOptionsProps> = ({soundOption, onChange}) => {
   return (
      <FormControl fullWidth>
         <InputLabel>Sound Option</InputLabel>
         <Select value={soundOption} onChange={e => onChange(e.target.value)}>
            <MenuItem value='default'>Default</MenuItem>
            <MenuItem value='metronomeClick'>Metronome Click</MenuItem>
            <MenuItem value='metronomeUp'>Metronome Up</MenuItem>
         </Select>
      </FormControl>
   );
};
